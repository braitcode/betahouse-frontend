          ...
          <div className="productInfo p-3">
            ...
            >
              <p className="border p-1">
                <span className="bg-warning p-1">Property Type</span>{" "}
              ...
              <p className="border p-1">
                <span className="bg-warning p-1">Location</span> {product?.location}
              </p>
              <p className="border p-1">
                <span className="bg-warning p-1">Bedroom</span> {product?.room}
              </p>
            </div>
