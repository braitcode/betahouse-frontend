  ...
  return (
    <div>
          <div className="overflow-hidden bg-white h-full w-full flex justify-center items-center">
              <div className="xl:w-[85%] w-[90%] my-[40px]">
                  <div className="flex flex-col justify-between">
                      <div className="flex justify-between">
                          <div className="xl:flex flex-row items-center gap-[20px]">
                              {/* <img src={filter} alt="" className='w-[18.9px] h-[18.9px]' /> */}
                              <p className='xl:text-[21px] flex items-center gap-4 font-outfit'><span><img src={filter} alt="" className='w-[18.9px] h-[18.9px]' /></span>More Filter</p>
                              <p className='xl:text-[21px] font-outfit'>Showing 1 - 10 of 15 results</p>
                          </div>
                          <div className="">
                              ...
                              <div className="rounded-lg  shadow-lg bg-white w-full">
                                  ...
                                  <div className="p-4 flex flex-col gap-[32px]">
                                      ...
                                      <div className="flex justify-between items-center ">
                                          <h2 className='font-outfit text-[20px] my-2 font-semibold'>{card.price}</h2>
